...
public class AutoScannerView extends View {
    ...
    private final int triAngleColor = Color.parseColor("#36DCE4");                        //边角的颜色
    private final int lineColor = Color.parseColor("#36DCE4");                            //中间线的颜色
...
//            canvas.drawLine(frame.left, frame.top + lineOffsetCount, frame.right, frame.top + lineOffsetCount, linePaint);    //画一条红色的线
            ...
            canvas.drawBitmap(((BitmapDrawable)(getResources().getDrawable(R.drawable.miku_scanline))).getBitmap(), null, lineRect, linePaint);
        }
